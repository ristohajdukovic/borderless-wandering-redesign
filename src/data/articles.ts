...
export const articles: Article[] = [
  {
    ...
    title: "If You Choose Bogota, You Have Never Been to Thailand: A Reality Check",
    excerpt:
      "Bangkok and Bogota are often grouped together in top expat city lists. On paper, both look attractive. In reality, they deliver very different daily experiences.",
    date: "Jan 4, 2026",
    readTime: "6 min read",
    image: article1,
    category: "City Comparison",
    tags: ["City Guides", "Cost", "Healthcare"],
    cityTag: "Bangkok / Bogota",
    youtubeId: "dPpvx9uEQ-c",
    content: [
      "If you are an American man over 50 thinking about retiring overseas, city comparisons matter more than lifestyle photos or cost-of-living charts. What really changes your quality of life is how a city feels once novelty fades.",
      "Bangkok and Bogota are often grouped together in top expat city lists. On paper, both look attractive. In reality, they deliver very different daily experiences - especially once comfort, safety, mobility, and long-term livability become priorities.",
      "This comparison is not about which city is better. It is about which city better supports low-friction living after 50.",
      "## Safety and Mental Load: What Your Nervous System Notices First",
      "Safety is not just crime statistics. It is the background mental energy required to move through a city.",
      "In Bogota, daily awareness is constant. You think about your phone. You think about your route. You read people's posture. You time exits. None of this feels dramatic - but it is continuous.",
      ...
      "> Retirement is not about excitement every day - it is about reducing unnecessary strain.",
      "For men thinking long-term, safety is not fear-based. It is energy-based.",
      "## Transportation: Freedom vs Fatigue",
      "Transportation defines how much of a city you actually use.",
      "Bogota's TransMilenio is functional but demanding. Crowds, unpredictability, and physical effort turn simple errands into tasks. Many people default to cars - which introduces traffic stress and dependency.",
      ...
      "- Bogota: transportation requires planning and tolerance.",
      ...
      "Malls are not about consumption - they are about climate control, accessibility, and services in one place.",
      "In Bogota, malls are functional but guarded. Security presence is obvious. You feel the boundary between inside and outside.",
      ...
      "When daily errands do not require mental or physical effort, life gets quieter - and better.",
      "## Coffee Culture and Daily Rituals",
      "Coffee culture reveals how a city treats time.",
      "Bogota's cafes feel purposeful. You arrive, order, drink, leave.",
      "Bangkok's cafes invite lingering. Power outlets, seating variety, quiet corners. They are designed for time, not turnover.",
      ...
      "This is not about adventure. It is about what you do not have to think about every single day.",
    ],
  },
  {
    id: "2",
    slug: "medellin-doesnt-hold-up-the-reality",
    title: "Medellin Does Not Hold Up to the Reality",
    excerpt:
      "Medellin sells a compelling storyline: a city reborn, an innovation hub, eternal spring, and a lifestyle destination. A different operating reality has become difficult to ignore.",
    date: "Jan 4, 2026",
    readTime: "10 min read",
    image: article2,
    category: "City Review",
    tags: ["City Guides", "Safety"],
    cityTag: "Medellin",
    youtubeId: "0WlPJYIiXys",
    content: [
      "Medellin sells a compelling storyline: a city reborn, an innovation hub, eternal spring, and a lifestyle destination for global visitors.",
      "A different operating reality has become difficult to ignore: targeted predation against foreigners linked to dating-app meetups and nightlife, normalized victim-blaming, a stratified social order that hardens separation, and an innovation narrative that looks increasingly contested.",
      "When trust is weak, daily life becomes more guarded, business becomes more expensive, and the city brand becomes a shield rather than a signal.",
      "Medellin is a high-friction base for long-term living if you value peace of mind, predictable social trust, and low-risk daily movement.",
      "## What This Article Is and Is Not",
      "- Is: a risk and reality memo for expats, remote workers, and operators considering Medellin as a base.",
      ...
      "## The Medellin Story People Buy",
      "The city's external narrative emphasizes transformation, modern urbanism, creative energy, and entrepreneurship - an exportable identity that attracts large numbers of visitors and short-term residents.",
      ...
      "2. Movement to semi-controlled spaces such as bars, apartments, or hotels",
      ...
      "Ruta N is positioned as a centerpiece of Medellin's innovation identity. The critique is not that innovation efforts are meaningless, but that innovation districts can become islands - physically and socially disconnected from surrounding communities.",
      "In HBR terms: innovation ecosystems are judged by retention, spillovers, and compounding capability, not slogans.",
    ],
  },
  {
    id: "3",
    ...
    excerpt:
      "After living in Asia for six years, returning to the United States does not feel like coming home. It feels like entering a system you remember but no longer move naturally within.",
    date: "Dec 30, 2025",
    readTime: "6 min read",
    image: article3,
    category: "Expat Life",
    tags: ["Remote Work", "City Guides"],
    cityTag: "United States",
    youtubeId: "7cNTdj0Hg40",
    content: [
      "After living in Asia for six years, returning to the United States does not feel like coming home. It feels like entering a system you remember but no longer move naturally within.",
      "This is not a critique of America. It is an observation of contrast.",
      "For men over 50 who have spent time abroad or are considering it, reentry becomes a powerful diagnostic. You do not just see what changed. You feel what costs more energy than it used to.",
      ...
      "The issue is not productivity. It is momentum.",
      ...
      "What once felt normal now feels conditional. Comfort is available, but it is tiered.",
      ...
      "## The Bottom Line",
      "Returning to the U.S. does not mean rejecting it. But it does mean seeing it clearly.",
  ...
  },
  {
    ...
    excerpt:
      "Despite the costs, America still offers unique advantages no other country can match. Here is what stands out after years abroad.",
    date: "Nov 30, 2025",
    ...
    cityTag: "United States",
    content: [
      "After years of living abroad and visiting dozens of countries, returning to America brings perspective that is impossible to gain while living here full-time.",
      "This is not about nationalism or criticism. It is about observation. What does America actually do differently, and often better, than anywhere else?",
      ...
      "The expectation of good service creates a culture where it is delivered. Returns are accepted. Problems get solved.",
